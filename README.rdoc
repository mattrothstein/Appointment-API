...
This is API was made to CREATE, READ, UPDATE and DELETE Appointments in our database. All appointments must have valid first and last names. You cannot create new appointments
...
``` -d '{ "appointment":{"first_name": "Matt", "last_name": "Rothstein", "start_time":"12/01/15 10:00", "end_time": "12/01/15 10:05", "comments" : "optional"}}'```

* UPDATE
PATCH https://hidden-cliffs-4643.herokuapp.com/appointments/:id
``` -d '{ "appointment":{"start_time":"12/01/15 09:55"}}'```
